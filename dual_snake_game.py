...
while game_is_on:
    ...
    screen.onkey(fun=l_snake.move_up, key="w")
    screen.onkey(fun=l_snake.move_down, key="s")
    screen.onkey(fun=l_snake.turn_right, key="d")
    screen.onkey(fun=l_snake.turn_left, key="a")
